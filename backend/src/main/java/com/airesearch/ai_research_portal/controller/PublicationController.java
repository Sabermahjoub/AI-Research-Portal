...
public class PublicationController {
    ...
    @PutMapping("/accept/{idPublication}")
    public ResponseEntity<String> acceptPublication(@PathVariable("idPublication") long idPublication) throws Exception {

        try {
            this.pubService.acceptPublication(idPublication);
            return new ResponseEntity<>("Publication accepted successfully",HttpStatus.OK);

        }
        // Other exceptions
        catch(Exception e) {
            return new ResponseEntity<>("Cannot accept publication",HttpStatus.INTERNAL_SERVER_ERROR);
        }
